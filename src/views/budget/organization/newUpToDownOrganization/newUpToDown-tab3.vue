<template>
  <div class="newUpToDownOrganization-tab3">
    <div class="tableBox">
      <el-table
        ...
        ref="table"
      >
        <el-table-column label="类别" prop="class1" class-name="first-title" min-width="40"></el-table-column>
        <el-table-column label="类别" prop="class2" class-name="second-title" min-width="40"></el-table-column>
        <el-table-column label="类别（单位：万元）" prop="verticalIndexName" class-name="third-title" min-width="120"></el-table-column>
...
export default {
  name: "newUpToDownOrganization-tab3",
