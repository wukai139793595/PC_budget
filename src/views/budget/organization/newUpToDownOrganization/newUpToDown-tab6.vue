    ...
    <div class="tableBox">
      ...
      >
        ...
        <el-table-column v-for="(item1,index1) in newArr" :label="item1.areaName" >
          <el-table-column :label="item2.class1" v-for="(item2,index2) in item1.list" min-width="100">
            <el-table-column :label="item2.horizonIndexName" :prop="'val'+(index1*2+index2)" min-width="100"></el-table-column>
          </el-table-column>
        </el-table-column>
      </el-table>
    </div>
...
<script>
    ...
    export default {
        name: "newUpToDownOrganization-tab6",
        props:{
            rowData:{
                type:Array,
                default:[]
