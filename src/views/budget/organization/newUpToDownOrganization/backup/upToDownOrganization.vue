  ...
  <div class="upToDownOrganization">
    ...
    <div class="tableBox">
      <el-table v-loading="tableLoading" :data="tableData" style="width: 100%" class="tableTh28"
                border :span-method="arraySpanMethod" height="68vh"
    ...
    methods: {
      ...
      exportBian(val) {
        ...
        if (process.env.NODE_ENV == 'development') {
          window.location.href = prefixAPI.loc + "/api/bottomUpEdit/exportData?detailId=" + val;
        } else if (process.env.NODE_ENV == 'production') {
          window.location.href = prefixAPI.hp + "/api/bottomUpEdit/exportData?detailId=" + val;
        }
      },
      //克隆
      clone(row) {
